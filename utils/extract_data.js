...
for (let index = 0; index < resultsArray.length; index++) {
    ...
    var sql = "INSERT INTO tbl_metricas (serviceName, status, responseTime, time_executed) VALUES ('"+serviceNameValue+"','"+ statusValue+"','"+ responseTimeValue+"','"+testExecutionTime+"')";
    //cy.writeFile('data.txt', '\nUF: '+serviceNameValue+','+ statusValue+','+responseTimeValue+ ',' +testExecutionTime+','  + date + '  ' + hora, {flag:'a+'})
